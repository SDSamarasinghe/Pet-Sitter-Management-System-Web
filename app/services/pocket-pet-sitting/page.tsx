        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <Button variant="outline" className="border-primary/20 text-primary hover:bg-gold-50 px-6 py-3 rounded-full font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <Card key={option.title} className="relative overflow-hidden shadow-lg border-0 bg-white hover:shadow-xl transition-shadow">
                {option.top && (
                  <div className="absolute top-3 right-3 bg-primary text-white text-xs px-3 py-1 rounded-full z-10 font-semibold">Popular</div>
                )}
                <div className="bg-primary text-white text-center py-4 px-2">
                  ...
                  <div className="text-sm text-gold-100">{option.duration}</div>
                </div>
                <div className="p-4">
                  ...
                  <Button className="w-full bg-primary hover:bg-gold-600 text-white py-2 rounded-lg font-semibold" onClick={() => router.push('/service-inquiry')}>Book Now</Button>
                </div>
              </Card>
            ))}
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={service.title} className="text-center bg-gray-50 rounded-lg p-4 hover:bg-gold-50 transition-colors">
                <div className="mb-4">
                  <img src={service.image} alt={service.title} className="w-16 h-16 object-cover mx-auto rounded-lg shadow-md" />
                </div>
                <h3 className="font-semibold text-primary text-sm">{service.caption}</h3>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">1</div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">3</div>
                  <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">4</div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-primary rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">5</div>
                  <div>
